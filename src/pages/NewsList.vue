<style scoped>
  ...
  .r-i-list li:hover, .bu-right-list:hover {
    transition: all .2s ease-in-out;
    color: #1aa0e3;
  }
</style>
...
<template>
  <div class="container">
    <div class="top-img"><img src="http://cdn.qiyewan.com/aritle-banner.png"></div>
    <el-row>
      <el-col :span="16">
        <div>
