<template>
    <div>
        <el-dialog title="企业湾账号注册" v-model="dialogVisible" size="tiny">
            <el-form label-position="top" :model="formStacked" class="demo-form-stacked">
                ...
                <el-form-item label="校验码">
                    ...
                    <el-button type="primary" style="width: 45%">点击获取</el-button>
                </el-form-item>
            ...
            <el-button type="primary" @click.native="dialogVisible = false" style="width: 100%">注 册</el-button>
        </el-dialog>
    </div>
</template>